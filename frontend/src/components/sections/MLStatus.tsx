...
interface MLHealth {
  ...
  circuitBreaker: 'closed' | 'half_open' | 'open' | string;
...
interface MLStatusProps {
  // compact mode can be added later if needed
}

export const MLStatus = (): React.ReactElement => {
  const { data: health, loading } = useAsyncData<MLHealth | null>(() =>
