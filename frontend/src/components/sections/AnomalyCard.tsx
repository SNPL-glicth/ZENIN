...
const DetectionMethods = ({ methods }: DetectionMethodsProps): React.ReactElement | null => (
...
export const AnomalyCard = ({ anomaly, expanded, onToggle }: AnomalyCardProps): React.ReactElement => {
